...
class TestTramway {
    ...
    public void testInstanciation() {
        //*********** Assis ****************************
        Tramway assis = new Tramway(66, 0);

        assert true == assis.aPlaceAssise();
        assert false == assis.aPlaceDebout();

        //************ Debout ***************************
        Tramway debout = new Tramway(0, 99);
     ...
     *
     * Remplir Tramway max assise et max debout - 1.
     *
