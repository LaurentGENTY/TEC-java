...
/**
 * Classe interne au paquetage afin que l'autobus puisse utiliser les fonctions
 * permettant de verifier s'il reste une place etc... MAIS inutilisables par le client
 */
abstract class Vehicule {
  ...
  /**
   * Change d'arrêt pour chaque passager
   * @param p */
